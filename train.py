...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s_person.yaml', help='model.yaml path')
    ...
    parser.add_argument('--workers', type=int, default=4, help='maximum number of workers for dataloader')
